...
from transformers import T5Tokenizer, RobertaTokenizer, get_linear_schedule_with_warmup
...
class Config:
    ...
    line_num_labels = 2
    expert_num = 6
    expert_dim = 768  # 修正为CodeT5-base的实际维度
...
def train(config):
    ...
    # 初始化tokenizer - 尝试加载正确的tokenizer类型
    try:
